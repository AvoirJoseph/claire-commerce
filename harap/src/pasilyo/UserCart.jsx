        ...
        <div className="navbar">
          ...
          <div className="navbar-right-side">
            <ul>
              ...
              <li> <Link to="/Profile/UserCart"> UserProfile </Link></li>
              <li> <Link to="/FrontPageNoLogIn"> Profile </Link></li>
            </ul>
          </div>
          ...
          <div className="productFrontColumn"> {/** if no products, say no products found */}
            ...
            filteredProducts.map((product) => (
                <div key={product.productID} className="productFrontRow">
                  <img src={`http://localhost:8800/images/${product.productImage1}`} alt={product.productName} />
